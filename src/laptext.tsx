...
export default function LapText() {
    ...
    useEffect(() => {
        if (!pathRef.current) return;
        // if (!rotateTextRef.current) return;
        ...
        for (let i = 0; i < text.length; i++) {
            ...
            const nextPoint = pathRef.current.getPointAtLength((position + .1) % total_length);
